...
header nav a:last-child{box-shadow:0 8px 18px rgba(28,25,23,.14)}
header nav a:hover{transform:translateY(-1px)}
h1,h2,h3{letter-spacing:-.025em}
#ruleta{filter:drop-shadow(0 18px 38px rgba(232,93,4,.08))}
#wheel{box-shadow:0 20px 48px rgba(28,25,23,.12),0 0 0 8px rgba(255,255,255,.96)!important}
...
.rf-footer-brand{display:flex;align-items:center;gap:10px;flex-wrap:wrap}.rf-footer-brand strong{display:inline-flex;align-items:center;font-size:1.1rem}.rf-footer-brand p{width:100%;margin:.35rem 0 0}
