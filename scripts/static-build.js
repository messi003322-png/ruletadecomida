...
@media(max-width:767px){.rf-final-footer{margin-top:52px!important}.rf-final-footer .rf-footer-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important}.rf-final-footer #seo-map-ciudades{padding-bottom:112px!important}}
</style>`;
...
// restore-guide-moment is intentionally disabled: it inserted the Moment block after the main guide script had already wired events.
