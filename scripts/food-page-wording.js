...
function run(){
  ...
  walk(DIST);
  console.log(`[food-page-wording] OK: ${changed} HTML procesados; títulos y textos de cabecera corregidos. Guías específicas gestionadas por food-category-guides.`);
}
